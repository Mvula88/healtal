  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="flex min-h-screen">
        {/* Left Side - Branding */}
        <div className="hidden lg:flex lg:w-1/2 p-12 flex-col relative" style={{
          ...
          >
              <div>
                <h2 className="text-4xl font-bold text-gray-900 mb-4">
                  ...
                  <span className="block gradient-text">self-discovery</span>
                </h2>
                <p className="text-lg text-gray-600">
                  Join thousands who are uncovering their patterns and transforming their lives with AI-powered insights.
                </p>
              </div>
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="lg:hidden text-center mb-8">
              ...
              <h1 className="mt-4 text-3xl font-bold text-gray-900">Start your journey</h1>
              <p className="mt-2 text-gray-600">Discover the patterns that shape your life</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <div className="mb-6">
                ...
                <h1 className="text-3xl font-bold text-gray-900 text-center lg:text-left">Create account</h1>
                <p className="mt-2 text-gray-600 text-center lg:text-left">Begin your journey to deeper self-understanding</p>
              </div>
                ...
                <div className="space-y-4">
                  <label className="flex items-start">
                    ...
                    <span className="ml-3 text-sm text-gray-600">
                      ...
                      <Link href="/disclaimers" className="text-teal-600 hover:text-teal-700 font-medium">
